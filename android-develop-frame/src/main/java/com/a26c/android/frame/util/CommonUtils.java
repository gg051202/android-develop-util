...
public class CommonUtils {
     ...
     *
     * @param listView
     * @param maxHeight listview的最大高度，0表示不限制
     */
    public static void setListViewHeightBasedOnChildren(Context context, ListView listView, int maxHeight) {
        maxHeight = FrameDensityUtils.dp2px(context, maxHeight);
